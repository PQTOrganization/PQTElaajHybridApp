...
const GoogleMapWithMarkersDX = (props: any) => {
  ...
  console.log(props.markers, isLoaded);

  const calculateRoute = async () => {
  
    const origin = { lat: props.markers[1].position.lat, lng: props.markers[1].position.lng };
    const destination = { lat: props.markers[0].position.lat, lng: props.markers[0].position.lng  };
